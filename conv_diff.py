...
#TODO:
# 1. convert Burgers into convection-diffusion equation:
# 2. either add convection-diffusion terms here or take con-diff equation and bring temporal terms there
#
from fenics import *
